<?php
/**
 * Plugin Name: Run Through History
 * Description: Run Through History core plugin.
 * Version:     0.1.0
 * Author:      Kellen Mace
...
add_action( 'plugins_loaded', function() {
    ...
    $display_admin_notice = function() use ( $missing_dependencies ) {
        ...
        <div class="notice notice-error">
            <p>The Run Through History core plugin can't be loaded because these dependencies are missing:</p>
            <ul>
    ...
    ( new RunThroughHistory\RunThroughHistory() )->run();
} );
